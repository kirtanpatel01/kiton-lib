import { CodeBox, Sidebar } from "./components";
...
const App = () => {
  ...
  return (
    <div className="sticky app flex flex-col sm:flex-row font-sans gap-3 sm:gap-6 bg-base dark:bg-darkBase dark:text-[#D7E5FF] duration-150">
      <Sidebar />
